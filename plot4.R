...
par(mfrow = c(2,2))
with(pow_cons, plot(datetime, Global_active_power, type = "l", ylab = "Global Active Power", xlab = ""))
with(pow_cons, plot(datetime, Voltage, type = "l"))
...
legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = rep(1,3), col = c("black", "red", "blue"), bg = NULL, bty = "n")
with(pow_cons, plot(datetime, Global_reactive_power, type = "l"))
dev.off()
